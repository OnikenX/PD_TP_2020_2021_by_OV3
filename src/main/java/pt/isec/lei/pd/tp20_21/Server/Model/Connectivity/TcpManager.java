...
//        }
        ...
        public void run() {
            ...
            try {
                ...
                bytes = Objects.requireNonNull(Utils.objectToBytes(input));
                oS.write(bytes);
                if (Utils.Consts.DEBUG)
                    System.out.println("enviado uma lista");
                oS.write(Objects.requireNonNull(Utils.objectToBytes(new ListasParaOClient(serverDB.getListaTabela(ServerDB.table_canaisGrupo), ServerDB.table_canaisGrupo))));
                oS.write(Objects.requireNonNull(Utils.objectToBytes(new ListasParaOClient(serverDB.getListaTabela(ServerDB.table_utilizadores), ServerDB.table_utilizadores))));
                oS.write(Objects.requireNonNull(Utils.objectToBytes(new ListasParaOClient(serverDB.getListaTabela(ServerDB.table_mensagens), ServerDB.table_mensagens))));
                while (!stop) {
                    if(Utils.Consts.DEBUG)
